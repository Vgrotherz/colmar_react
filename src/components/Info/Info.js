                ...
                <div className="special">
                    ...
                    <div className="three-pictures">
                        <div className="small-picture">
                            <img id="small-picture-one" class="desktop" src="./capstone_colmar_assets/images/information-orientation.jpg" alt="info" />
                            <img className="mobile" src="./capstone_colmar_assets/images/information-orientation-mobile.jpg" alt="info" />
                        ...
                        <div className="small-picture">
                            <img className="desktop" src="./capstone_colmar_assets/images/information-campus.jpg" alt="campus" />
                            <img className="mobile" src="./capstone_colmar_assets/images/information-campus-mobile.jpg" alt="campus" />
                            <div className="small-blocktext">
                                <h1>Our campus</h1>
                        ...
                        <div className="small-picture three">
                            <img className="desktop" src="./capstone_colmar_assets/images/information-guest-lecture.jpg" alt="guest" />
                            <img className="mobile" src="./capstone_colmar_assets/images/information-guest-lecture-mobile.jpg" alt="guest" />
                            <div className="small-blocktext">
